...
class AppointmentClinicItem extends StatelessWidget {
  const AppointmentClinicItem(
      {super.key,
      this.onTap1,
      this.onTap2,
      this.butttonName1,
          ...
          Row(crossAxisAlignment: CrossAxisAlignment.center, children: [
            ClipRRect(
              ...
              child: Image(
                ...
                width: 50,
                fit: BoxFit.fill,
                image: appointment.hospital!.clinic!.image.isNotEmpty
                    ? CachedNetworkImageProvider(
                        appointment.hospital!.clinic!.image)
                    : AssetImage(
            ...
            isUpcoming ?? false
                ? GestureDetector(
                    onTap: () {
                      ...
                      context.pushNamed(AppRoutes.googlemap, arguments:appointment);
                    },
                    child: Container(
