        ...
        if (state is GetAppointmentsLoading && cubit.selectedIndex == 1) {
          ...
          if (completedVisits.appointments == null ||
            ...
            return EmptyAppointments(
              title: 'appointments.youDontHaveCompletedAppointments'.tr(),
            );
          } else {
            return ListView.builder(
                ...
                itemBuilder: (context, index) {
                  return Padding(
                      ...
                      child: completedVisits.appointments![index].clinic != null
                          ? AppointmentItem(
                          ...
                          : completedVisits.appointments![index].hospital !=
                                  null
                              ? AppointmentClinicItem(
                                  appointment:
                                      completedVisits.appointments![index],
                                  onTap1: () {
                                    log(user.toJson().toString());
                                    log(completedVisits.appointments![index]
                                        .clinic!.workTimes!.workTimes![0]
                                        .toJson()
                                        .toString());
                                    log(completedVisits
                                        .appointments![index].doctor!.id!);
                                    context.pushNamed(
                                        AppRoutes.pickAppointmentDate,
                                        arguments: {
                                          'workTimes': completedVisits
                                              .appointments![index]
                                              .doctor!
                              ...
                              : completedVisits.appointments![index].lab != null
                                  ? AppointmentLabItem(
                                      appointment:
                                          completedVisits.appointments![index],
                                      onTap1: () {
                                      ...
                                      withButtons: true,
                                      butttonName1:
                                          'appointments.bookAgain'.tr(),
                                      butttonName2:
                                          'appointments.leaveReview'.tr(),
                                    )
                                  : const SizedBox());
                });
          }
