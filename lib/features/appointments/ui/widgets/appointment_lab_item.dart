...
class AppointmentLabItem extends StatelessWidget {
  const AppointmentLabItem(
      {super.key,
      this.onTap1,
      this.onTap2,
      this.butttonName1,
          ...
          Row(crossAxisAlignment: CrossAxisAlignment.center, children: [
            ClipRRect(
              ...
              child: Image(
                ...
                width: 50,
                fit: BoxFit.fill,
                image: appointment.lab!.lab!.image != null
                    ? CachedNetworkImageProvider(appointment.lab!.lab!.image!)
                    : AssetImage(
            ...
            Column(
              ...
              children: [
                ...
                Text(
                  '${appointment.lab!.lab!.specialty}'.tr(),
