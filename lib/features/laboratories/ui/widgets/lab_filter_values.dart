...
class LabFilterValues extends StatelessWidget {
  const LabFilterValues({super.key});

  @override
  Widget build(BuildContext context) {
    var filterValues = context.read<LaboratoriesCubit>().filterValues;
    return Padding(
          ...
          child: Row(
            children: [
              ...
              Container(
                ...
                decoration: BoxDecoration(
                  color: filterValues['speciality'] == null ||
                          filterValues['speciality'] == 'All'
                      ? AppColors.mainColor.withAlpha(20)
                      : AppColors.mainColor,
                  borderRadius: BorderRadius.circular(20),
                ),
                child: Text(
                    filterValues['speciality'] == null ||
                        ...
                        : 'specialities.${filterValues['speciality']}'.tr(),
                    style: Theme.of(context).textTheme.bodySmall!.copyWith(
                          color: filterValues['speciality'] == null ||
                                  filterValues['speciality'] == 'All'
                              ? AppColors.mainColor
