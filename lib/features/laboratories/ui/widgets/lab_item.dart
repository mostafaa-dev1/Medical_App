...
class LabItem extends StatelessWidget {
  const LabItem({super.key, required this.lab, required this.user});
  final LabsInfo lab;
                      ...
                      children: [
                        ...
                        Row(
                          children: [
                            ...
                            horizontalSpace(5),
                            Text(
                              Format.formatNumber(lab.lab!.rate ?? 0, context),
          ...
          Row(
            children: [
              ...
              Expanded(
                child: Text(
                  addressBuilder(
                      lab.address!, lab.city!, lab.government!, context),
                  style: Theme.of(context).textTheme.labelMedium,
                ),
              ),
            ],
          ...
          Row(
            children: [
              ...
              CustomButton(
                  ...
                  onPressed: () {
                    context.pushNamed(AppRoutes.laboratoriesProfile,
                        arguments: {
                          'lab': lab,
                          'context': context,
                          'user': user
