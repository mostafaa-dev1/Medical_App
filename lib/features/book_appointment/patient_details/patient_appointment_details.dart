                ...
                child: Column(
                  ...
                  children: [
                    ...
                    CustomTextFrom(
                      ...
                      validator: (v) {
                        if (v == null || v.isEmpty) {
                          return 'appointments.nameRequired'.tr();
                        }
                        return null;
                      },
                    ...
                    CustomTextFrom(
                      ...
                      validator: (v) {
                        if (v == null || v.isEmpty) {
                          return 'appointments.ageRequired'.tr();
                        }
                        return null;
                      },
                    ...
                    AppCustomDropDown(
                        ...
                        validator: (value) {
                          if (value == null || value.isEmpty) {
                            return 'appointments.genderRequired'.tr();
                          }
                          return null;
                        },
                    ...
                    CustomTextFrom(
                      ...
                      validator: (v) {
                        if (v == null || v.isEmpty) {
                          return 'appointments.phoneRequired'.tr();
                        }
                        return null;
                      },
                    ),
                    verticalSpace(20),
                    widget.appointment.lab != null
                        ? SizedBox()
                        : CustomTextFrom(
                            maxLines: null,
                            withhint: true,
                            ...
                            validator: (v) {
                              if (v == null || v.isEmpty) {
                                return 'appointments.problemRequired'.tr();
                              }
                              return null;
                            },
                            keyboardType: TextInputType.text,
