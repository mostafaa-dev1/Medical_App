...
import 'package:medical_system/features/home/ui/widgets/offers/data/data_services/offers_data.dart';
...
class MainCubit extends Cubit<MainState> {
  ...
  Future<void> getOffers() async {
    ...
    // Fetch upcoming appointments
    final response = await _offeraData.getOffers(
      provider: 'Doctors',
    );
    response.fold((l) {
